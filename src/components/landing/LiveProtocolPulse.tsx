...
import { Activity, ShieldCheck, Cpu, Wifi, ExternalLink, Zap } from 'lucide-react';
...
export default function LiveProtocolPulse() {
  ...
  return (
    <div className="w-full border-y border-white/[0.06] bg-[#07090e]/80 backdrop-blur-md py-3.5 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-4 text-xs font-mono text-zinc-400">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-white uppercase tracking-wider text-[11px]">Stellar Soroban Mainnet Architecture</span>
          </div>
          ...
          <div className="flex items-center gap-1.5" title="Horizon RPC Latency">
            ...
            <span>RPC:</span>
            <span className="text-cyan-300 font-semibold">{latency !== null ? `${latency}ms` : '135ms'}</span>
          </div>
        ...
        <div className="flex items-center gap-4 text-[11px]">
          <div className="flex items-center gap-1.5" title="Network fee per transaction">
            ...
            <span>Avg Gas:</span>
            <span className="text-amber-300 font-semibold">0.00001 XLM (~$0.000001)</span>
          </div>
